Shader "Basics Lighting/Two-Sided Surface"
{
    Properties
    {
    ...
    SubShader
    {
        Pass 
        {
            ...
            vertexOutput vert(vertexInput input)
            {
                ...
                float distance = dot(normalDirection, lightDirection);
                float3 ambientLighting = UNITY_LIGHTMODEL_AMBIENT.rgb * _Color.rgb;
                float3 diffuseReflection = attenuation * _LightColor0.rgb * _Color.rgb * max(0.0, distance);
